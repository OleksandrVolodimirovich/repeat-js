...
вставляється 
                переміщується на місце елемента котрий заміняється. Першим вказую елемент котрий заміняю, 
...
<h1>innerHTML - <span>це метод задопомогою котрого можна вставити текст, а також HTML-теги. 
                Неможна використовувати для збору
            даних від користувача, можна ввести скрипт який зруйнує сайт</span></h1>
